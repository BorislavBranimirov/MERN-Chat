...
module.exports = function (server) {
    ...
    io.on('connection', (socket) => {
        ...
        // username used for typing is derived, verified and stored here, instead of being sent as an argument
        // along with the roomId in the 'userTyping' event, so that the user can't change the token
        // or react state on the client-side and appear as a different person in the message
